                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 16.0, 0.0, 0.0),
                                child: Semantics(
                                  label: 'Clique para criar sua conta.',
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      _model.accountCreateResponse =
                                          await UsersGroup.pOSTUserCall.call(
                                      ...
                                      if ((_model.accountCreateResponse
                                              ?.succeeded ??
                                          true)) {
                                        await showDialog(
                                          context: context,
                                        ...
                                        await showDialog(
                                          ...
                                          builder: (alertDialogContext) {
                                            return AlertDialog(
                                              ...
                                              content: Text(
                                                  'Digite dados válidos para a criação da sua conta.'),
                                              actions: [
                                                TextButton(
                                                  onPressed: () =>
                                                      Navigator.pop(
                        ...
                        Padding(
                          ...
                          child: Semantics(
                            label:
                                'Clique para ir para a página de fazer o login.',
                            child: FFButtonWidget(
                              onPressed: () async {
