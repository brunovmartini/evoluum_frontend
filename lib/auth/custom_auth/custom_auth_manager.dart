...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    evoluumTasksAuthUserSubject.add(
      EvoluumTasksAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<EvoluumTasksAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  EvoluumTasksAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = EvoluumTasksAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    evoluumTasksAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
EvoluumTasksAuthUser? currentUser;
