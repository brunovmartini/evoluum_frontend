    ...
    return Column(
      ...
      children: [
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Semantics(
                  label: 'Clique para fazer o login.',
                  child: FFButtonWidget(
                    onPressed: () async {
                      _model.apiResulteja = await UsersGroup.pOSTLoginCall.call(
                        username: _model.textController1.text,
                        password: _model.textController2.text,
                      );

                      if ((_model.apiResulteja?.succeeded ?? true)) {
                        GoRouter.of(context).prepareAuthEvent();
                        await authManager.signIn(
                          authenticationToken: UserStruct.maybeFromMap(
                                  (_model.apiResulteja?.jsonBody ?? ''))
                              ?.accessToken,
        ...
        Padding(
          ...
          child: Semantics(
            label: 'Clique para ir para a página de criar conta.',
            child: FFButtonWidget(
              onPressed: () async {
                context.pushNamed(AccountCreationWidget.routeName);
              },
              text: 'Criar Conta',
              options: FFButtonOptions(
                height: 40.0,
